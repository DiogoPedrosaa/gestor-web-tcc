      ...
      <AuthProvider>
        <Routes>
          ...
          <Route element={<Layout />}>
            ...
            <Route path="/administradores" element={<ProtectedRoute requireAdmin><AdminsPage /></ProtectedRoute>} />
            <Route path="/medicações" element={<ProtectedRoute requireAdmin><MedicationsPage /></ProtectedRoute>} />
          </Route>
